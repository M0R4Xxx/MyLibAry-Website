        ...
        <div class="p-8 max-w-[1600px] mx-auto space-y-10 mb-7">    
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <section class="space-y-4">
                    <div class="flex items-center justify-between px-2 pt-4 w-full">
                        ...
                        <button onclick="window.location.href='{{ route('admin.reports.export_pdf', ['month_range' => request('month_range', 'all')]) }}'"
                        class="group relative isolate overflow-hidden bg-white border border-slate-200 px-6 py-3 rounded-2xl text-fuchsia-600 font-bold text-[10px] 
                            hover:text-white hover:-translate-y-1.5 hover:shadow-xl hover:shadow-fuchsia-500/30 
                            transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] 
                            flex items-center gap-2 uppercase tracking-widest font-accent shadow-sm shadow-fuchsia-100/50 transform-gpu will-change-transform">
                            ...
                            <span class="relative z-10 leading-none flex items-center transform-gpu" style="backface-visibility: hidden;">Export To PDF</span>
                            <span class="material-icons-round text-sm group-hover:translate-x-1 transition-transform duration-500" style="backface-visibility: hidden;">
                                picture_as_pdf
                            </span> 
                        </button>
                    </div>
                    ...
                    <div class="pt-4">
                        <div class="flex flex-wrap items-center justify-center gap-6 py-4">
                            ...
                            <div class="relative" x-data="{ open: false }" @click.away="open = false">
                                ...
                                <div x-show="open" 
                                    ...
                                    <div class="py-2 max-h-80 overflow-y-auto custom-scrollbar-fuchsia"> 
                                ...
                                <style>
                                    .custom-scrollbar-fuchsia::-webkit-scrollbar { width: 4px; }
                                    .custom-scrollbar-fuchsia::-webkit-scrollbar-track { background: transparent; }
                                    .custom-scrollbar-fuchsia::-webkit-scrollbar-thumb { 
                        ...
                        <div class="section-container hover-fuchsia group relative isolate !mt-6">
                            ...
                            <div class="flex justify-center items-center gap-2 font-accent pt-8 pb-0">
                        ...
                        <section class="space-y-4">
                            <div class="flex items-center justify-between px-2 pt-4 w-full">                    
                                <div class="flex items-start gap-1">
                                    <div class="relative">
                                        <h4 class="text-4xl font-extrabold tracking-tighter font-heading pb-1 -mb-1 pr-4 inline-block text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-amber-600 to-orange-500 transform-gpu" 
                                            ...
                                            Comprehensive Fine Settlement Ledger
                                        </h4>
                                        ...
                                        <div class="flex items-center gap-2.5 mt-2">
                                            ...
                                            <p class="text-amber-600 font-black text-[10px] uppercase tracking-[0.2em] font-accent leading-none">
                                                REAL-TIME TRACKING OF REVENUE STREAMS FROM OVERDUE FINES AND PAYMENTS.
                                            </p>
                                        </div>
                                    </div>

                                    <div class="flex flex-col items-start justify-center min-w-[120px] w-fit group mt-0">
                                        <div class="flex items-center justify-start gap-2">
                                            ...
                                            <span class="font-accent text-[9px] font-black uppercase tracking-[0.3em] text-amber-600/60 leading-none transition-all duration-300 group-hover:translate-x-0.5 group-hover:scale-105 origin-left">
                                                Accumulated Fines
                                            </span>
                                        </div>
                                    
                                        <div class="relative mt-1">
                                            <div class="flex items-baseline gap-2 w-fit">
                                            ...
                                            <div class="relative w-full h-1 mt-1 hidden md:block">
                                ...
                                <button onclick="window.location.href='{{ route('admin.reports.export_fine_pdf', ['fine_month' => request('fine_month', 'all')]) }}'"
                                class="group relative isolate overflow-hidden bg-white border border-slate-200 px-6 py-3 rounded-2xl text-amber-600 font-bold text-[10px] 
                                    hover:text-white hover:-translate-y-1.5 hover:shadow-xl hover:shadow-amber-500/30 
                                    transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] 
                                    flex items-center gap-2 uppercase tracking-widest font-accent shadow-sm shadow-amber-100/50 transform-gpu will-change-transform">
                        ...
                        <div class="pt-0">
                            <div class="flex flex-wrap items-center justify-center gap-6 py-4">
                                    ...
                                    <div class="w-full max-w-2xl relative h-[70px] flex items-center">
                                        <form action="{{ route('admin.reports') }}" method="GET" class="w-full relative group flex items-center m-0">
                                            ...
                                            <input 
                                                ...
                                                placeholder="Search Fine by Title, Member, Price or Status (Unpaid/Pay Off)..."
                                            />
                                        </form>
                                    </div>
                                ...
                                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                                    <button @click="open = !open" 
                                            ...
                                            class="relative overflow-hidden flex items-center justify-center bg-amber-600 px-4 py-3 rounded-[1.25rem] text-white w-52
                                                ...
                                                transition-all duration-500 [transition-timing-function:cubic-bezier(0.34,1.56,0.64,1)]
                                                hover:shadow-[0_20px_40px_rgba(217,119,6,0.5)] hover:-translate-y-2 hover:scale-[1.02]
                                                group" 
                                            :class="open ? 'shadow-[0_20px_40px_rgba(217,119,6,0.5)] -translate-y-2 scale-[1.02]' : ''">
                                        ...
                                        <span class="relative z-10 flex items-center justify-center w-full gap-2">
                                            ...
                                            <span class="text-sm font-semibold font-accent tracking-wide truncate text-center flex-1">
                                                {{ $fineSortOptions[request('fine_sort', 'latest_fine')] ?? 'Newest Fine Transaction' }}
                                            </span>
                                            <span class="material-symbols-outlined text-sm transition-all duration-500 group-hover:scale-125 shrink-0 origin-center" 
                                                :class="open ? 'rotate-180 scale-125' : ''">
                                                expand_more
                                    ...
                                    <div x-show="open" 
                                        ...
                                        <div class="py-2 max-h-80 overflow-y-auto custom-scrollbar"> 
                                            @foreach($fineSortOptions as $key => $label)
                                                @php $isActive = request('fine_sort', 'latest_fine') == $key; @endphp
                                                
                                                <a href="{{ request()->fullUrlWithQuery(['fine_sort' => $key]) }}"
                                                class="group mx-2 mb-2 flex items-center justify-between px-4 py-2.5 rounded-xl text-sm border-2 transition-all duration-500 ease-out font-accent font-semibold
                                                {{ $isActive 
                                                    ? 'bg-amber-600 border-amber-600 text-white pointer-events-none' 
                                ...
                                <div class="relative h-[70px] flex items-center" x-data="{ open: false }" @click.away="open = false">
                                    <button @click="open = !open" 
                                        ...
                                        <span class="absolute inset-0 bg-gradient-to-r from-amber-700 to-amber-500 opacity-0 transition-opacity duration-500 group-hover:opacity-100" :class="open ? 'opacity-100' : 'opacity-0'"> </span>
                                        ...
                                        <span class="relative z-10 flex items-center justify-center w-full gap-2">
                                            ...
                                            <span class="text-sm font-semibold font-accent tracking-wide truncate text-center flex-1">
                                                {{ $fineStatusOptions[$currentFineFilter] ?? 'Filter' }}

                                                @if($currentFineMonth !== 'all')
                                                    <span class="opacity-75 mx-1">|</span> 
                                                    <span class="text-[11px] italic">{{ $currentFineMonth }}</span>
                                                @endif
                                            </span>
                                            <span class="material-symbols-outlined text-sm transition-all duration-500 group-hover:scale-125 shrink-0 origin-center" 
                                                :class="open ? 'rotate-180 scale-125' : ''">
                                    ...
                                    <div x-show="open" 
                                        ...
                                        <div class="py-2 max-h-80 overflow-y-auto custom-scrollbar"> 
                                            {{-- Bagian Status --}}
                                            @foreach($fineStatusOptions as $val => $label)
                                                @php $activeStatus = ($currentFineFilter == $val); @endphp
                                                <a href="{{ request()->fullUrlWithQuery(['fine_filter' => $val === 'all' ? null : $val]) }}"
                                                class="group mx-2 mb-2 flex items-center justify-between px-4 py-2.5 rounded-xl text-sm border-2 transition-all duration-500 ease-out font-accent font-semibold
                                                {{ $activeStatus 
                                                    ? 'bg-amber-600 border-amber-600 text-white pointer-events-none' 
                                                    : 'bg-white dark:bg-transparent border-amber-100 dark:border-amber-900/30 text-amber-600 hover:bg-amber-600 hover:border-amber-600 hover:text-white hover:-translate-y-1' }}">
                                            ...
                                            <div class="h-[5px] w-full bg-gradient-to-r from-transparent via-amber-300 to-transparent dark:via-amber-900/50 my-4 opacity-80"></div>

                                            @foreach($monthRangeOptions as $key => $label)
                                                @php 
                                                    $activeMonth = ($currentFineMonth == $key);
                                                @endphp
                                                <a href="{{ request()->fullUrlWithQuery(['fine_month' => $key === 'all' ? null : $key]) }}"
                                                class="group mx-2 mb-2 flex items-center justify-between px-4 py-2.5 rounded-xl text-sm border-2 transition-all duration-500 ease-out font-accent font-semibold
                                                {{ $activeMonth 
                                                    ? 'bg-amber-600 border-amber-600 text-white pointer-events-none' 
                                                    : 'bg-white dark:bg-transparent border-amber-100 dark:border-amber-900/30 text-amber-600 hover:bg-amber-600 hover:border-amber-600 hover:text-white hover:-translate-y-1' }}">
                            ...
                            <div class="section-container hover-amber group relative isolate !mt-6">
                                    <div class="glow-edge absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-fuchsia-400/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-10"></div>
                                    <div class="absolute inset-0 bg-white/10 transition-colors duration-700 ease-in-out group-hover:bg-white/20 -z-10"></div>
                                ...
                                <div class="flex justify-center items-center gap-2 font-accent pt-8 pb-2">
                                    @if ($fineReports->hasPages())
                                        {{-- Tombol Previous --}}
                                        @if ($fineReports->onFirstPage())
                                            {{-- Hilang/Kosong sesuai perilaku kode referensi --}}
                                        @else
                                            <a href="{{ $fineReports->previousPageUrl() }}" class="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-xl border-2 border-slate-200 bg-white text-slate-400 hover:text-amber-600 hover:border-amber-600 hover:-translate-y-1.5 transition-all duration-300 shadow-sm mr-2 group">
                                                <span class="material-symbols-outlined text-sm transition-transform group-hover:scale-110">arrow_back_ios_new</span>
                                            </a>
                                        @endif
                                        ...
                                        {{-- Logika Perhitungan Angka --}}
                                        @php
                                            $currentPage = $fineReports->currentPage();
                                            $lastPage = $fineReports->lastPage();
                                            $start = max(1, $currentPage - ($currentPage == $lastPage ? 2 : 1));
                                            $end = min($lastPage, $currentPage + ($currentPage == 1 ? 2 : 1));
                                        ...
                                        {{-- Halaman Pertama & Separator --}}
                                        @if($start > 1)
                                            <a href="{{ $fineReports->url(1) }}" class="w-9 h-9 flex items-center justify-center rounded-lg border-2 border-slate-200 bg-white text-slate-400 font-medium text-[11px] hover:text-amber-600 hover:border-amber-600 hover:-translate-y-1.5 transition-all duration-300 shadow-sm">1</a>
                                            @if($start > 2)
                                                <div class="flex items-center justify-center h-12">
                                                    <span class="text-slate-400 px-1 text-[12px] font-extrabold tracking-widest leading-none">...</span>
                                                </div>
                                        ...
                                        @foreach (range($start, $end) as $page)
                                            @if ($page == $currentPage)
                                                {{-- STATUS AKTIF: Hitam, Lebih Besar (w-14), Shadow 2XL, Glow Amber --}}
                                                <div class="relative group transition-all duration-300">
                                                    <span class="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-2xl bg-slate-900 text-white font-black text-base shadow-2xl shadow-slate-900/30 z-10 relative">
                                                        {{ $page }}
                                                    </span>
                                                    <div class="absolute inset-0 bg-amber-500/20 blur-xl rounded-full scale-75 group-hover:scale-110 transition-all duration-300"></div>
                                                </div>
                                            @else
                                                {{-- STATUS TIDAK AKTIF: Border 2, Hover Amber 600, Translate-y --}}
                                                <a href="{{ $fineReports->url($page) }}" class="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center rounded-xl border-2 border-slate-200 bg-white text-slate-500 font-bold text-sm hover:text-amber-600 hover:border-amber-600 hover:-translate-y-1.5 transition-all duration-300 shadow-sm">
                                                    {{ $page }}
                                                </a>
                                            @endif
                                        @endforeach
                                        ...
                                        @if($end < $lastPage)
                                            ...
                                            @endif
                                            <a href="{{ $fineReports->url($lastPage) }}" class="w-9 h-9 flex items-center justify-center rounded-lg border-2 border-slate-200 bg-white text-slate-400 font-medium text-[11px] hover:text-amber-600 hover:border-amber-600 hover:-translate-y-1.5 transition-all duration-300 shadow-sm">
                                                {{ $lastPage }}
                                            </a>
                                        @endif

                                        {{-- Tombol Next --}}
                                        @if ($fineReports->hasMorePages())
                                            <a href="{{ $fineReports->nextPageUrl() }}" class="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-xl border-2 border-slate-200 bg-white text-slate-400 hover:text-amber-600 hover:border-amber-600 hover:-translate-y-1.5 transition-all duration-300 shadow-sm ml-2 group">
                                                <span class="material-symbols-outlined text-sm transition-transform group-hover:scale-110">arrow_forward_ios</span>
                                            </a>
                                        @endif
                                    @endif
